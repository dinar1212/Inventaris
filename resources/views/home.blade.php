                      ...
                      <div class="card card-statistics">
                        <div class="card-body">
                          <div class="clearfix">
                            ...
                            <div class="float-right">
                              <p class="card-text text-dark">Komputer</p>
                          ...
                          <div class="clearfix">
                            <div class="float-left">
                              <h4 class="text-success">
                                <i class="fa fa-bookmark-cart highlight-icon" aria-hidden="true"></i>
                              </h4>
                            </div>
                            <div class="float-right">
                              <p class="card-text text-dark">Lab</p>
                              <h4 class="bold-text">16</h4>
                            </div>
                          </div>
                          <p class="text-muted">
